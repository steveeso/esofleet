...
def _migrate(db):
    ...
    _ensure_column(db, "catalog_items", "location_code", "TEXT")
    ...
    _ensure_column(db, "catalog_items", "napa_stock", "INTEGER")
    _ensure_column(db, "catalog_items", "napa_stock_checked_at", "TEXT")
